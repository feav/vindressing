...
class Horaire_Ouverture
{
	...
	{
		global $pdo;
		$SQL = "CREATE TABLE `horaire_ouverture` (`id` int(16) NOT NULL AUTO_INCREMENT,`jour` text NOT NULL,`heure_ouverture1` time NOT NULL,`heure_fermeture1` time NOT NULL,`heure_ouverture2` time NOT NULL,`heure_fermeture2` time NOT NULL,PRIMARY KEY (`id`))";
		$pdo->query($SQL);
		...
		if($req[0] == 0)
		{
			$SQL = "INSERT INTO `horaire_ouverture` (`id`, `jour`, `heure_ouverture1`, `heure_fermeture1`, `heure_ouverture2`, `heure_fermeture2`, `isOpen`) VALUES
(1, 'Tue', '09:00:00', '18:00:00', '09:00:00', '18:00:00', 'oui'),
(2, 'Mon', '09:00:00', '18:00:00', '09:00:00', '18:00:00', 'oui'),
(3, 'Wed', '09:00:00', '18:00:00', '09:00:00', '18:00:00', 'oui'),
(4, 'Thu', '09:00:00', '18:00:00', '09:00:00', '18:00:00', 'oui'),
(5, 'Fri', '09:00:00', '18:00:00', '09:00:00', '18:00:00', 'oui'),
(6, 'Sat', '09:00:00', '18:00:00', '09:00:00', '18:00:00', 'oui'),
(7, 'Sun', '09:00:00', '18:00:00', '09:00:00', '18:00:00', 'oui');";
			$pdo->query($SQL);
		}
	}
