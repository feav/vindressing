<?php
    ...
    $hotline            = adiva_get_option('hotline', '(001) 2222-3333');
...
<div class="main-navigation hidden-sm hidden-xs">
    <div class="container">
        <div class="header-row row">
            <?php if( isset($hotline) && $hotline != '' ) : ?>
            <div class="header-position col-lg-9 col-md-9 col-sm-9">
            <?php else : ?>
                ...
                <div class="header-block">
                        ...
                        <?php
                            if ( class_exists('Adiva_Megamenu_Walker') ) {
                                $menu = array(
                                    ...
                                    'menu_class'      => 'adiva-menu primary-menu menu-left',
                    ...
                    <?php else : ?>
                        <div class="primary-menu-wrapper">
                            <ul class="adiva-menu primary-menu menu-left">
            ...
            <?php if( isset($hotline) && $hotline != '' ) : ?>
                <div class="header-position col-lg-3 col-md-3 col-sm-3 tr">
                    <div class="header-block">
                        <div class="header-hotline flex middle-xs">
                            <span class="sl icon-phone"></span>
                            <p><span><?php esc_html_e('Call Us:', 'adiva'); ?></span><?php echo esc_html($hotline); ?></p>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
