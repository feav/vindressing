...
$pids = denso_get_bought_together_products( array($product->get_id()) );
...
if ( $products->have_posts() ) : ?>
	...
	<div class="boughtproducts products widget">
		<h3 class="widget-title"><span><?php esc_html_e( 'Customers Who Bought This Item Also Bought', 'denso' ); ?></span></h3>
