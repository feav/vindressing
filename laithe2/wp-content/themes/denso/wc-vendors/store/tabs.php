...
<div class="woocommerce-tabs tabs-v2">
	<ul class="tabs-list nav nav-tabs">
		<?php if ($description != '') { ?>
			<li class="active"><a data-toggle="tab" href="#tabs-list-about"><?php esc_html_e( 'About Shop', 'denso' ); ?></a></li>
		<?php } ?>
		<?php if (!$vendor_rating_page) { ?>
			<li><a data-toggle="tab" href="#tabs-list-review"><?php esc_html_e( 'Review', 'denso' ); ?></a></li>
		<?php } ?>
		<li><a data-toggle="tab" href="#tabs-list-best-deals"><?php esc_html_e( 'Best Deals', 'denso' ); ?></a></li>

		<?php if ( !empty($shipping_policy) || !empty($return_policy) ) { ?>
			<li><a data-toggle="tab" href="#tabs-list-shipping"><?php esc_html_e( 'Shipping Policy', 'denso' ); ?></a></li>
		<?php } ?>
	</ul>
			...
			<div class="tab-pane" id="tabs-list-shipping">
				...
				<?php if ( $shipping_policy != '' ):  ?>
					<div class="shipping_policy">
						<h3><?php esc_html_e( 'Shipping Policy', 'denso' ); ?></h3>
				...
				<?php if ( $return_policy != '' ):  ?>
					<div class="return_policy">
						<h3><?php esc_html_e( 'Return Policy', 'denso' ); ?></h3>
