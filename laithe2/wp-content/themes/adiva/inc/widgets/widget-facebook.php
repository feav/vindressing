...
// Widget class
class Adiva_Facebook_Widget extends WP_Widget {

    public function __construct() {
        parent::__construct(
            'Adiva_Facebook', // Base ID
            esc_html__('JMS - Facebook Widget', 'adiva'),
            array( 'description' => esc_html__( 'Widget that displays Facebook Like Box', 'adiva' ) ) // Args
        );
    }
    ...
    function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_url($this->get_field_id( 'page_url' )); ?>"><?php esc_html_e('Facebook Page URL :', 'adiva') ?> <small"> Example: http://www.facebook.com/envato </small"></small>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'show_faces' )); ?>"><?php esc_html_e('Show Faces:', 'adiva') ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'show_stream' )); ?>"><?php esc_html_e('Show Stream:', 'adiva') ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'width' )); ?>"><?php esc_html_e('Like box width:', 'adiva') ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'height' )); ?>"><?php esc_html_e('Like box height :', 'adiva') ?></label>
...
// register widget
function adiva_register_facebook() {
	register_widget( 'Adiva_Facebook_Widget' );
}
add_action( 'widgets_init', 'adiva_register_facebook' );
