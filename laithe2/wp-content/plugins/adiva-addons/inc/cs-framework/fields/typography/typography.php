...
class CSFramework_Option_typography extends CSFramework_Options {
  ...
  public function output() {
    ...
    if( is_object( $google_json ) ) {
      ...
      echo '<optgroup label="'. esc_attr__( 'Web Safe Fonts', 'adiva-addons' ) .'">';
      ...
      echo '<optgroup label="'. esc_attr__( 'Google Fonts', 'adiva-addons' ) .'">';
      ...
      echo __( 'Error! Can not load json file.', 'adiva-addons' );
