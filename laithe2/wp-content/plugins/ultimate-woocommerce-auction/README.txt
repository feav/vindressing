...
*   [PRO Version - Upgrade to unlock awesome features &raquo;](https://auctionplugin.net?utm_source=wordpress.org&utm_medium=link&utm_campaign=woo-auction-from-wp.org)
 ...
 = PRO Features =
	...
	2. Automatic or Proxy Bidding
	3. Soft-Close or Anti-Sniping feature to extend time
	4. Automatic and Manual Relisting of Expired Auction
	5. Add Auction for Future Dates.
	6. Add Silent auctions
	7. Variable Increment
	8. Reverse Bidding Engine
	9. Bulk Import
	10. Live Bidding without page refresh
	11. Delete User Bids
	12. Support Virtual Products
	13. WPML and LocoTranslate Compatible
	14. Widgets - Expired, Future 
	15. Custom Emails
	16. Many Shortcodes & Filters 
