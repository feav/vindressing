	...
	<div class="container">
		<div class="popup">
			<div class="logoconnexion">
				<div class="round">
					<img src="images/big-toutou-pas-script.png">
				</div>
			</div>
			<H1>Mise à jour v1.72.6</H1>
			<div class="info-news">
			Dans cette nouvelle version vous retrouverez :<br><br>
			<ul>
			<li>- Update fichier de Language Français problème sur Mes Annonces.</li>
			<li>- Fix Warning dans la classe Sociale.</li>
			</ul>
			</div>
			<div class="operation">
